...
class TextAndCSVParserFuzzer {
    ...
    private static void parseOne(byte[] bytes) throws TikaException, IOException, SAXException {
        ...
        //hint to Tika that this is a csv so that it isn't accidentally parsed as text/plain
        metadata.set(TikaCoreProperties.CONTENT_TYPE_USER_OVERRIDE, "text/csv; delimiter=comma");
