...
class M3U8ParserFuzzer {
    ...
    private static void parseOne(byte[] bytes) throws TikaException, IOException, SAXException {
        ...
        Class clazz = null;
        try {
            clazz = Class.forName("org.apache.tika.parser.m3.M3U8Parser");
        ...
        try {
            ...
            throw new RuntimeException("m3u8 parser exists, but something went horribly wrong");
        }
